...
namespace Otus.Teaching.Pcf.ReceivingFromPartner.WebHost.Controllers
{
    ...
    public class PartnersController(IRepository<Partner> partnersRepository, IRepository<Preference> preferencesRepository,  INotificationGateway notificationGateway, IMessageService messageService): ControllerBase
    {
            ...
            ReceivingPromoCodeRequest request)
        {
            ...
            var promocodeDto = new GivePromoCodeToCustomer()
            {
            ...
            await messageService.PublishMessage(promocodeDto);
